...
4. Apply Lab 3 schema/data (`lab3-create.sql`, `lab3-insert.sql`).
...
- **DWH**: rerun `\i /workspace/lab2-insert.sql` from the `dwh` database.
...
## Next Steps
Lab 4+ can build on this stack by adding stored procedures inside `dwh` and `dm` or extending FDW refresh logic.
